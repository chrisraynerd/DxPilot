...
public sealed class AppSettings
{
    ...
    public int WantedItemExpirySeconds { get; set; } = 180;
    public int ManualWantedMaxAgeSeconds { get; set; } = 90;
    public string WantedScope { get; set; } = "Overall";
    public string WantedSniperMode { get; set; } = "Off";
    ...
    public int JtdxBandVisibleRowCount { get; set; }
    ...
    public int JtdxGuiMaxRowAgeSeconds { get; set; } = 45;
}
