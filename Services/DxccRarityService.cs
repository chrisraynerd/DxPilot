...
public sealed partial class DxccRarityService
{
    ...
    private readonly Dictionary<string, string> _aliases = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        ["FEDERAL REPUBLIC OF GERMANY"] = "FED REP OF GERMANY",
        ...
        ["DPRK NORTH KOREA"] = "DPR OF KOREA",
        ["SAN FELIX ISLANDS"] = "SAN FELIX AND SAN AMBROSIO",
        ["KERGUELEN ISLAND"] = "KERGUELEN ISLANDS",
        ["SAINT PETER AND PAUL ROCKS"] = "ST PETER AND ST PAUL",
        ["NEW ZEALAND SUBANTARCTIC ISLANDS"] = "NZ SUBANTARCTIC IS",
        ["BAKER HOWLAND ISLANDS"] = "BAKER AND HOWLAND ISLANDS",
        ["KERMADEC ISLAND"] = "KERMADEC ISLANDS",
        ["PRINCE EDWARD AND MARION ISLANDS"] = "PR EDWARD AND MARION IS",
        ["JUAN DE NOVA EUROPA"] = "JUAN DE NOVA AND EUROPA",
        ["TRINDADE AND MARTIM VAZ ISLANDS"] = "TRINDADE AND MARTIM VAZ",
        ["AMSTERDAM AND ST PAUL ISLANDS"] = "AMSTERDAM AND ST PAUL IS",
        ["GLORIOSO ISLAND"] = "GLORIOSO ISLANDS",
        ["BOUVET ISLAND"] = "BOUVET",
        ["ANNOBON"] = "ANNOBON ISLAND",
        ["AGALEGA AND ST BRANDON ISLANDS"] = "AGALEGA AND ST BRANDON",
        ["ANDAMAN AND NICOBAR ISLANDS"] = "ANDAMAN AND NICOBAR IS",
        ["SAINT PAUL ISLAND"] = "ST PAUL ISLAND",
        ["SOV MILITARY ORDER OF MALTA"] = "SOV MIL ORDER OF MALTA",
        ["COCOS KEELING ISLAND"] = "COCOS KEELING ISLANDS",
        ["ROTUMA"] = "ROTUMA ISLAND",
        ["CHATHAM ISLAND"] = "CHATHAM ISLANDS",
        ["SAINT PIERRE AND MIQUELON"] = "ST PIERRE AND MIQUELON",
        ["UK BASES ON CYPRUS"] = "UK BASE AREAS ON CYPRUS",
        ["SAINT BARTHELEMY"] = "ST BARTHELEMY",
        ["SAN ANDRES ISLAND"] = "SAN ANDRES AND PROVIDENCIA",
